          ...
          {!success ? (
            ...
            <div className="p-8 text-center">
              <div className="w-16 h-16 bg-charcoal-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-charcoal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link
                to="/app/contacts"
                className="inline-block py-3 px-6 rounded-md font-medium text-white bg-charcoal-600 hover:bg-charcoal-700 focus:outline-none focus:ring-2 focus:ring-charcoal-500 focus:ring-offset-2 transition-colors"
              >
                Get Started
              </Link>
            </div>
